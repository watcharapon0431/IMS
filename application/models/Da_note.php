...
class Da_note extends CI_Model {		
	...
	function insert() {
		$sql = "INSERT INTO `note` (note_to_do_list, note_create_date, note_user_id)
				VALUES (?, ?, ?)";
		$this->db->query($sql, array($this->note_to_do_list, $this->note_create_date, $this->note_user_id));
	}
