<script>
    ...
    function year_option() {
        ...
        /* Start set option to element select class year */
        for (let i = 0; i < 5; i++) {
            $("select.year").append(new Option(fiscal_year - i, (fiscal_year - i) - 543));
        }
        /* End set option to element select class year */
    }

    function report_get_table_by_page_number_search(page_number) {
        let table = $("#report_table tbody")
        let page = $("#page_option").val()
        let year = 2021
        let month =3
        console.log(month)
        table.empty()
        ...
        $.ajax({
            ...
            success: function(json_data) {
                ...
                let count_data = 0
                console.log("json_data.rs_income.length")
                ...
                <div class="panel panel-default">
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="col-md-10">
                                <div class="col-md-6">
                                    <h2><i class="fa fa-list-alt" style="font-size:40px;"></i>&emsp;จัดการรายรับ-รายจ่าย <?php echo date("Y");    ?></h2>
                                </div>
                                <div class="col-md-2">
                            ...
                            <form class="form-horizontal">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <label class="col-md-4">เดือน : </label>
                                            <div class="col-md-12">
                                    ...
                                    <!-- ------------------------------------------------ end status select search  --------------------------------------------- -->

                                </div>


                                <!-- <input type="hidden" class="form-control" id="department_type_id" value="2"> -->
